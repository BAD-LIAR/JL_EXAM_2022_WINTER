...
public class QaGeneratorApplication {
    ...
    public Binding binding(Queue queue, TopicExchange topicExchange) {
        return BindingBuilder.bind(queue).to(topicExchange).with("qa");
    }
    ...
    public static void main(String[] args) {
        SpringApplication.run(QaGeneratorApplication.class, args);
    }
